...
export namespace Host {
  ...
  export const deleteHost = function(id: string): Promise<void> {
    return axios.delete('/host/' + id)
  }

  export const addHostGroup = function(title: string): Promise<void> {
  ...
  export const updateHost = function(id: string, host: HostItem): Promise<void> {
    return axios.put('/host/' + id, host)
  }
  ...
  export const metaInfos = {
    os: {
      ...
      ubuntu:
        'data:image/svg+xml,%3Csvg width=\'2500\' height=\'2500\' viewBox=\'0 0 256 256\' xmlns=\'http://www.w3.org/2000/svg\' preserveAspectRatio=\'xMidYMid\'%3E%3Cpath d=\'M255.637 127.683c0 70.514-57.165 127.68-127.683 127.68C57.434 255.363.27 198.197.27 127.683.27 57.165 57.436 0 127.954 0c70.519 0 127.683 57.165 127.683 127.683z\' fill=\'%23DD4814\'/%3E%3Cpath d=\'M41.133 110.633c-9.419 0-17.05 7.631-17.05 17.05 0 9.414 7.631 17.046 17.05 17.046 9.415 0 17.046-7.632 17.046-17.046 0-9.419-7.631-17.05-17.046-17.05zm121.715 77.478c-8.153 4.71-10.95 15.13-6.24 23.279 4.705 8.154 15.125 10.949 23.279 6.24 8.153-4.705 10.949-15.125 6.24-23.28-4.705-8.148-15.131-10.943-23.279-6.239zm-84.686-60.428c0-16.846 8.368-31.73 21.171-40.742L86.87 66.067c-14.914 9.97-26.012 25.204-30.624 43.047 5.382 4.39 8.826 11.075 8.826 18.568 0 7.489-3.444 14.174-8.826 18.565C60.852 164.094 71.95 179.33 86.87 189.3l12.463-20.88c-12.803-9.007-21.171-23.89-21.171-40.737zm49.792-49.797c26.013 0 47.355 19.944 49.595 45.38l24.29-.358c-1.194-18.778-9.398-35.636-22.002-48.032-6.482 2.449-13.97 2.074-20.44-1.656-6.483-3.741-10.548-10.052-11.659-16.902a74.26 74.26 0 0 0-19.785-2.69 73.787 73.787 0 0 0-32.819 7.663l11.845 21.227a49.596 49.596 0 0 1 20.975-4.632zm0 99.59a49.601 49.601 0 0 1-20.974-4.632l-11.845 21.225a73.712 73.712 0 0 0 32.82 7.671 74.04 74.04 0 0 0 19.784-2.697c1.111-6.85 5.177-13.155 11.658-16.902 6.476-3.737 13.959-4.105 20.44-1.656 12.605-12.396 20.808-29.254 22.004-48.032l-24.297-.358c-2.235 25.443-23.576 45.38-49.59 45.38zm34.888-110.231c8.154 4.708 18.575 1.92 23.279-6.234 4.71-8.154 1.92-18.575-6.234-23.285-8.154-4.704-18.574-1.91-23.285 6.244-4.703 8.15-1.908 18.57 6.24 23.275z\' fill=\'%23FFF\'/%3E%3C/svg%3E',
      unknown:
        'data:image/svg+xml,%3Csvg t=\'1719980777827\' class=\'icon\' viewBox=\'0 0 1024 1024\' xmlns=\'http://www.w3.org/2000/svg\' p-id=\'17938\' width=\'200\' height=\'200\'%3E%3Cpath d=\'M319.0784 323.584a72.704 72.704 0 0 1 44.8512-14.6432c16.896 0 31.6928 4.864 44.288 14.592 13.0048 9.728 23.04 23.4496 30.2592 41.1136 7.2192 17.6128 10.8032 37.9904 10.8032 61.0304 0 23.04-3.584 43.4176-10.752 61.0816-7.2192 17.664-17.3056 31.3344-30.3104 41.0624-12.5952 9.728-27.3408 14.592-44.288 14.592a72.704 72.704 0 0 1-44.8512-14.592 94.4128 94.4128 0 0 1-30.2592-41.0624 160.6144 160.6144 0 0 1-10.8032-61.0816c0-23.04 3.584-43.4176 10.752-61.0304 7.2192-17.664 17.3056-31.3856 30.3104-41.1136z\' fill=\'%23B7BBCC\' p-id=\'17939\'%3E%3C/path%3E%3Cpath d=\'M35.84 124.8768C35.84 84.1728 66.2016 51.2 103.7312 51.2h814.592c37.5296 0 67.8912 32.9728 67.8912 73.6768v619.1616c0 40.704-30.3616 73.728-67.84 73.728H103.7312c-37.5296 0-67.8912-33.024-67.8912-73.728V124.928z m406.4256 152.7296A144.7424 144.7424 0 0 0 363.9296 256c-29.5424 0-55.808 7.168-78.8992 21.6064-23.04 14.08-41.0624 34.048-54.0672 60.0064-12.9536 25.6-19.456 54.9376-19.456 88.064 0 33.536 6.5024 63.0784 19.456 88.6272 13.0048 25.6 30.976 45.4144 54.0672 59.4432 23.04 14.4384 49.3568 21.6576 78.848 21.6576 29.184 0 55.296-7.2192 78.3872-21.6576 23.04-14.0288 41.0624-33.8432 54.0672-59.392 12.9536-25.6 19.456-55.1424 19.456-88.6784 0-33.1264-6.5024-62.464-19.456-88.064a143.4624 143.4624 0 0 0-54.0672-60.0064z m150.3744 23.808c-9.728 14.0288-14.5408 30.208-14.5408 48.64 0 52.5824 35.4816 84.2752 106.4448 95.0784 28.1088 3.9936 47.36 9.9328 57.856 17.8688 10.752 7.5264 16.1792 19.2512 16.1792 35.1232 0 14.7456-5.632 26.2656-16.7424 34.56-11.2128 7.936-26.5216 11.8784-45.9776 11.8784-41.0624 0-67.328-17.1008-78.848-51.3024l-50.2784 23.2448c7.5776 25.1904 22.6816 44.6464 45.3632 58.368 22.7328 13.6704 51.712 20.48 87.04 20.48 24.1152 0 45.568-4.3008 64.3072-12.9536 18.7392-8.2944 33.28-19.968 43.776-35.1232 10.752-15.5136 16.1792-33.28 16.1792-53.504 0-29.184-9.0112-51.8656-26.9824-68.096-18.0224-16.5376-45.9264-27.5456-83.7632-32.9728-25.9584-3.9424-43.9808-9.1648-54.0672-15.6672a33.1776 33.1776 0 0 1-15.104-29.184c0-12.9536 4.864-23.04 14.592-30.208 9.728-7.2192 23.2448-10.8544 40.4992-10.8544 35.6864 0 57.856 14.08 66.5088 42.1376l50.7904-23.1936c-6.144-21.6576-19.8144-38.5536-41.1136-50.8416-20.8896-12.5952-47.1552-18.8928-78.848-18.8928-22.7328 0-43.0592 3.9424-61.0816 11.8784a98.4064 98.4064 0 0 0-42.1888 33.536zM778.8544 972.8H243.2c-18.688 0-33.9456-16.5888-33.9456-36.864 0-20.224 15.2576-36.8128 33.9456-36.8128h535.4496c18.6368 0 33.8944 16.5888 33.8944 36.864 0 20.224-15.104 36.8128-33.792 36.8128z\' fill=\'%2325B195\' p-id=\'17940\' data-spm-anchor-id=\'a313x.search_index.0.i2.4a533a81XMMpef\' class=\'selected\'%3E%3C/path%3E%3C/svg%3E'
    }
  }
}
