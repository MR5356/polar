    ...
    <div class="p-4 flex gap-4 select-none">
      ...
      <div class="w-3/4 h-fit grid grid-cols-2 gap-4">
        ...
        <div v-loading="isFirstLoading" class="col-span-2 grid grid-cols-4 gap-4 bg-white bg-opacity-60 dark:bg-slate-600 rounded-lg p-4">
          ...
          <div class="cursor-pointer min-h-[50px] text-slate-700 dark:text-slate-100 shadow-lg shadow-sky-100 dark:shadow-slate-700 bg-sky-50 dark:bg-slate-600 rounded-lg p-4 relative" @click="onClickAddHealth" >
